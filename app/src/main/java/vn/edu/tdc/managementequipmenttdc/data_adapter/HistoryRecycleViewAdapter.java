...
public class HistoryRecycleViewAdapter extends RecyclerView.Adapter<HistoryRecycleViewAdapter.MyViewHolder> {
    ...
    public HistoryRecycleViewAdapter(int layoutID, Vector<DisplayListNotifycationCardViewModel> listData) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView, final OnItemClickListener onItemClickListener) {
            ...
            txtNotifycationContent = (TextView) itemView.findViewById(R.id.historyTxtNotifycationContent);
            txtNotifycationDate = (TextView) itemView.findViewById(R.id.historyTxtNotifycationDate);
